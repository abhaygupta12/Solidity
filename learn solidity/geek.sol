...
//     _;
  ...
  function getUsers() constant public returns (address[]) { return usersByAddress; }

  function getUser(address userAddress) constant public returns (string,bytes32,bytes32,bytes32,bytes32[]) {
  ...
  function getAllImages() constant public returns (bytes32[]) { return imagesByNotaryHash; }

  function getUserImages(address userAddress) constant public returns (bytes32[]) { return Users[userAddress].myImages; }

  function getImage(bytes32 SHA256notaryHash) constant public returns (string,uint) {
